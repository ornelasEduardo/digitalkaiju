...
export default function Labs() {
  return (
    <>
      <Head>
        <title>DigitalKaiju Labs - R&D Projects</title>
        <meta
          name="description"
          content="A home for all our R&D and hobby projects. Where we experiment, build, and break things in the name of innovation."
        />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <nav className="flex space-x-8">
                ...
                <a href="/labs" className="text-green-600 font-semibold">
                  Labs
                </a>
              </nav>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    An experimental web framework built for the next generation
                    of applications.
                  </p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    A suite of tools for monitoring and optimizing web
